...
const data = new SlashCommandBuilder()
    .setName('filters')
    .setDescription('ฟิลเตอร์สำหรับเพลง')
    .addStringOption((o) =>
        o
            .setName('เลือก')
            .setDescription('เลือกฟิลเตอร์สำหรับเพลง')
            .addChoices(
            ...
            switch (selectFilters) {
                ...
                case 'nightcore':
                    ...
                    response = player.filterManager.filters.nightcore
                        ? 'เปิดการใช้งาน Nightcore แล้วค่ะ หากเปิด Karaoke อยู่แนะนำให้ปิดนะคะ !'
                        : 'ปิดการใช้งาน Nightcore แล้วค่ะ';
                    break;
                case 'karaoke':
                    await player.filterManager.toggleKaraoke();
                    response = player.filterManager.filters.karaoke
                        ? 'เปิดการใช้งาน Karaoke แล้วค่ะ หากเปิด Nightcore อยู่แนะนำให้ปิดนะคะ'
